    ...
    AMA.augment(LocationMapView.prototype, {
        ...
        initialize: function (options) {
            ...
            */
            ...
            this.options.mapWidth = options && options.mapWidth || AMA.config.locationPaneMap.width;
        ...
        render: function () {
            ...
            if (this.data && this.data.length > 0) {
                ...
                var pushpin = new Microsoft.Maps.Pushpin(pushpinLoc, {htmlContent: pushpinContent, zIndex: 1020, visible: true});
        ...
        _createInfoBox: function(index) {
            ...
            // item.title = "Location History " + (index-1);
            // if(index == 1) {
                // item.title = "Device Located";
            // }
