    ...
    AMA.augment(Content.prototype, {
        ...
        render: function () {
            ...
            if (!AMA.models.capabilities.canRead("contacts") && 
	            ...
	            if( AMA.models.capabilities.canRead("browserSecuritySettings") ) {
	                this.safeBrowsingTab = new AMA.view.SafeBrowsingTabView({
	                    el: "#safe_browsing_tab",
	                    parent: this,
	                    data: AMA.models.safeBrowsing
	                });
	                $("#safebrowsing_tab").show();
	            }
	            else {
	                $("#safebrowsing_tab").hide();
	                $("#safe_browsing_tab").hide();
