...
AMA.debug("Security Settings sync data:"+JSON.stringify(this.data.models[0]));  // TODO: remove this debug log before production
		...
		// showMessage: function(message, section, validation, updateCallbacks, data)
		// {
			// //hide loading image
			// $("#" + section + "_submit .connecting").hide();

			// if(section === "settings")
			// {
				// $(".settings_intro .intro_after_save_message").html(message);
			// }
			// $("#" + section + "_submit .after_save_message").html(message);
		// },
