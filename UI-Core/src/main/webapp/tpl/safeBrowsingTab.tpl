<script type="text/template" id="safe_browsing_tab_template">
	<div id="safebrowsingpane" class="windowb" style="display: block;">
		<div id="safebrowsing">
			<input type="hidden" value="Unable To Contact services" id="safe_browsing_save_error"/>
				...
				<div class="safebrowsing_settings" style="display: block;">
					...
					<div class="pane_floatingbuttons">
						<ul>
							...
							<li class="after_save_message btnSafeBrowsingSaveMsg noChanges">No changes made.</li>
							<li class="after_save_message btnSafeBrowsingSaveMsg settingsSaved">Settings Successfully Saved!</li>
						</ul>
					</div>
				</div>
			</div>
